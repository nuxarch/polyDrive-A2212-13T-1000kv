...
#define OCP_MODE_OCP_ACTIVE 0x0000
...
#define OCTW_MODE_MASK 0x0003
#define OCTW_MODE_REPORT_BOTH_OT_OC_AT_OCTW_PIN 0x0000
#define OCTW_MODE_REPORT_OT_ONLY 0x0001
#define OCTW_MODE_REPORT_OC_ONLY 0x0002
#define OCTW_MODE_REPORT_OC_ONLY_RESERVED 0x0003

#define GAINOFSHUNT_AMPLIFIER_MASK  0x0006
#define GAINOFSHUNT_AMPLIFIER_10    0x0000
#define GAINOFSHUNT_AMPLIFIER_20    0x0004
#define GAINOFSHUNT_AMPLIFIER_40    0x0005
#define GAINOFSHUNT_AMPLIFIER_80    0x0006
...
public:
    ...
    */
    ...
    /**
    * Get DRV8301's gate current state
    * @retval   gate current
    */
    int get_Gate_Current(void);
    int get_PWM_Mode(void);
    int get_ocp_mode(void);
    int get_octw_mode(void);
    int get_gain(void);
    void activate_ocp(void);
